  ...
  return (
    <section ref={orderRef} className="py-12 bg-primary text-white-1">
      <div className="container mx-auto px-4 text-center">
        <header>
          <h2
            className={`font-lato text-2xl font-bold mb-6 ${
              orderVisible
        ...
        <p
          className={`font-opensans text-lg mb-8 max-w-2xl mx-auto ${
            orderVisible ? "animate__animated animate__fadeInUp" : "opacity-0"
          }`}
        >
